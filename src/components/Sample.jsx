  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center  container mx-auto  ">
        <h3 className="text-[rgb(16,23,39)] font-extrabold  text-3xl">
        ...
        <div className="grid   sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12   my-12">
          ...
          <div className="card w-96 bg-base-100 shadow-sm bg-blue-400">
            <div className="card-body p-6  rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transition duration-300">
              ...
              <div className="mt-6 flex justify-center">
                <button className="btn btn-soft btn-primary">Start Pro Trial</button>
              </div>
            </div>
          </div>
          <div className="card w-96 bg-base-100 shadow-sm">
            <div className="card-body p-6 bg-white rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transition duration-300">
